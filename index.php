                                        ...
                                        <div class="d-flex flex-column gap-3 mb-lg-10">
                                            ...
                                            <div class="d-flex flex-column gap-5">
                                                ...
                                                <div class="d-flex flex-row align-items-center gap-2">
                                                    <a href="#!"><img src="<?= PROOT; ?>assets/media/svg/playstore.svg"
                                                            alt="playstore"></a>
                                                    <a href="#!"><img src="<?= PROOT; ?>assets/media/svg/appstore.svg"
                                                            alt="appstore"></a>
                                                    <img src="<?= PROOT; ?>assets/media/svg/qr-code.svg" alt="qr-code"
                                                    class="icon-md icon-shape">
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <svg width="82" height="20" viewBox="0 0 82 20" fill="none"
                                          ...
                                          <g clip-path="url(#clip0_2350_3858)">
                                             ...
                                             <path
                                                ...
                                                fill="#00B67A" />
                                             <path d="M13.9557 13.072L13.4396 11.4826L9.72668 14.1625L13.9557 13.072Z"
                                                fill="#005128" />
                                          </g>
                                          <defs>
